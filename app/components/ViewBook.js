...
import ViewBookWebView from './ViewBookWebView';
...
export default class TopBarIconExample extends Component {
  ...
  state = {
    index: 0,
    routes: [
      { key: '1', title: 'Back', icon: 'arrow-left' },
    //   { key: '2', title: 'Bookmark', icon: 'bookmark-o' },
      { key: '2', title: 'Share', icon: 'share-alt' }, 
    ],
  };
